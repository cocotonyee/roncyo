  ...
  return (
    <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 lg:px-12">
      ...
      <p className="mt-4 text-base leading-relaxed text-[var(--color-muted)]">
        How we collect, use, and share information across our website, apps, and related services.
      </p>
      ...
      <div className="prose-legal mt-10">
        ...
        <p>
          ...
          websites, apps, platform services, and related digital products operated by{" "}
          {site.legalName}.
        </p>
        ...
        <p>
          In many of our apps and products, we do not require you to create an account or directly
          submit personal information. If you contact us, however, we may collect information such as
        ...
        <p>
          Our apps and related services may use third-party analytics tools and advertising partners
          (for example in mobile apps). These third parties may collect information as described in
          their own privacy policies, including device identifiers, usage information, cookies, and ad
          performance data, where permitted by law and platform rules.
        </p>
        <p>
        ...
        <p>
          ...
          violation of applicable law. If you believe that a child has provided personal information to
          us inappropriately, please contact us and we will take reasonable steps to review and address
          the issue.
        </p>
        ...
        <p>
          ...
          you understand that your information may be transferred to and processed in jurisdictions
        ...
        <p>
          ...
          the right to access, correct, delete, or restrict certain processing. You may also be able to
          control personalized advertising through your device settings or platform permissions.
        </p>
        ...
        <p>
          Our services may contain links to third-party websites or use third-party SDKs and services.
          We are not responsible for the privacy practices of those third parties, and we encourage you
        ...
        <p>
          Email: <a href={`mailto:${site.emails.privacy}`}>{site.emails.privacy}</a>
          <br />
