#!/usr/bin/env node
/**
 * Production build: single index.html — simple ad landing for roncyo.com.
 */
...
console.log(`✓ out/index.html — ${bytes} bytes (${(bytes / 1024).toFixed(1)} KB)`);
console.log(`  ad placement: ${ROIIFY.placement}`);
