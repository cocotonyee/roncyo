...
const AD_STRIP = `<aside id="roiify-ad-mid" class="ad-strip" aria-label="Advertisement"><div class="ad-slot" data-roiify-format="banner"></div></aside>`;
